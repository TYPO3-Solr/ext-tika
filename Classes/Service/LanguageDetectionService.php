...
class LanguageDetectionService extends AbstractService {
	...
	public $prefixId = 'LanguageDetectionService'; // Same as class name
	public $scriptRelPath = 'Classes/Service/LanguageDetectionService.php'; // Path to this script relative to the extension dir.
