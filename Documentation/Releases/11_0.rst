...
- [BUGFIX] Actions replace LOCAL_VOLUME_NAME with SOLR_VOLUME_NAME `6e474bd <https://github.com/TYPO3-Solr/ext-tika/commit/6e474bd>`_
- [TASK] Raise PHP restriction to 8.3.99 on release-11.0.x `998fff8 <https://github.com/TYPO3-Solr/ext-tika/commit/998fff8>`_
